export default class {
  ...
  hoveredCursor() {
    document.querySelectorAll('a:not(.no-hovered), button:not(.no-hovered), input:not(.no-hovered), textarea:not(.no-hovered), select:not(.no-hovered), .hovered, .style-select, .ss-selected-option, .js-employee, .swiper-pagination-bullet').forEach(item => {
